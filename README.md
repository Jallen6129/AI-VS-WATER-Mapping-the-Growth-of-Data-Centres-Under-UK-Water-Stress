...
```
# **File guidance**
Use the Solve.py Files to generate the parteo_results.json result files. Then use these files in the build_excel.py code to genertae the sc_optimistaion_results.xlsx
# **Optimisation Model**
